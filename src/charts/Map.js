...
anychart.charts.Map.prototype.unboundRegions = function(opt_value) {
  if (goog.isDef(opt_value)) {
    ...
    this.invalidate(anychart.ConsistencyState.MAP_APPEARANCE, anychart.Signal.NEEDS_REDRAW);
    return this;
  }
  ...
  if (goog.isDef(opt_data)) {
    ...
    if (this.geoData_ != opt_data) {
      ...
      this.invalidate(anychart.ConsistencyState.MAP_SCALE |
          ...
          anychart.ConsistencyState.MAP_APPEARANCE, anychart.Signal.NEEDS_REDRAW);
    }
    return this;
  }
...
anychart.charts.Map.prototype.drawContent = function(bounds) {
  ...
  if (this.hasInvalidationState(anychart.ConsistencyState.MAP_APPEARANCE)) {
    var path;
